...
})({"lTZuo":[function(require,module,exports) {
"use strict";
...
(0, _auth.onAuthStateChanged)((0, _login.auth), async (user)=>{
    if (user) {
        const q = (0, _firestore.query)((0, _constants.getRefs)(user.uid).user);
...
},{"firebase/auth":"79vzg","firebase/firestore":"8A4BC","./login":"47T64","./constants":"itKcQ"}]},["lTZuo","bvS82"], "bvS82", "parcelRequire2ffc")

//# sourceMappingURL=settings.2edba2db.js.map
