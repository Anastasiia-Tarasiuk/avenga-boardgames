...
})({"1Dboo":[function(require,module,exports) {
"use strict";
...
},{}],"dXtqq":[function(require,module,exports) {
...
function getActiveTab(e) {
    ...
    if (activeTab === gamesListEl) (0, _constants.filterList)(e, gamesData, gamesListEl, renderGamesSettings);
...
async function changePlayerVisibility(e, playerId) {
    ...
    try {
        ...
        playersData.forEach((player)=>{
            if (player.id === playerId) player.hidden = !checkbox.checked;
        });
        await (0, _firestore.updateDoc)(playerRef, {
            hidden: !checkbox.checked
        });
        (0, _notiflixNotifyAio.Notify).success("The player visibility was changed successfully");
    } catch (e1) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1Dboo","dXtqq"], "dXtqq", "parcelRequire2ffc")
