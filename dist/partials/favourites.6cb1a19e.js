...
})({"30TJ8":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "9914ee5a6cb1a19e";
...
},{}],"kiwNd":[function(require,module,exports) {
...
const gameData = [];
filterEl.addEventListener("keydown", (0, _lodashDebounceDefault.default)((e)=>(0, _constants.filterList)(e, gameData, favouriteGamesListEl, renderFavouriteGames), 500));
...
(0, _auth.onAuthStateChanged)((0, _login.auth), (user)=>{
    if (user) {
        const q = (0, _firestore.query)((0, _constants.getRefs)(user.uid).favourites);
        (0, _constants.pageRender)(user.uid, q, favouriteGamesListEl, gameData, renderFavouriteGames, target, spinner);
    } else if (localStorage.getItem("logout")) target.removeChild(spinner.el);
});
async function renderFavouriteGames(game, userId, show) {
    ...
    imageEl.addEventListener("click", (e)=>(0, _constants.showImage)(game.url, showMoreModalOverlay));
...
},{"firebase/auth":"79vzg","./login":"47T64","firebase/firestore":"8A4BC","lodash.debounce":"3JP5n","./constants":"itKcQ","spin.js":"iZQ5x","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["30TJ8","kiwNd"], "kiwNd", "parcelRequire2ffc")

//# sourceMappingURL=favourites.6cb1a19e.js.map
