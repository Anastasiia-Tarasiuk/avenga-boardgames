...
})({"d0CQu":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "98b7d89ad1048b88";
...
},{}],"crlNm":[function(require,module,exports) {
...
closePlayerModalButtonEl.addEventListener("click", (e)=>(0, _constants.closeModal)(addPlayerModalOverlay));
...
async function submitPlayerForm(e) {
    ...
    if (name.length > 0) {
        ...
        if (querySnapshot.empty) {
            ...
            form.reset();
            (0, _constants.closeModal)(addPlayerModalOverlay);
...
},{"firebase/auth":"79vzg","./login":"47T64","notiflix/build/notiflix-notify-aio":"eXQLZ","firebase/firestore":"8A4BC","lodash.debounce":"3JP5n","./constants":"itKcQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","spin.js":"iZQ5x"}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["d0CQu","crlNm"], "crlNm", "parcelRequire2ffc")
