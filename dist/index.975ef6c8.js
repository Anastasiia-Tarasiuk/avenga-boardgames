...
},{"./js/game_search":"eYq3g","./js/login":"47T64"}],"eYq3g":[function(require,module,exports) {
...
function renderGames(obj) {
    ...
    if (Array.isArray(categories)) categories.forEach((el)=>{
...
function xmlToJson(xml) {
    ...
    if (xml.hasChildNodes() && xml.childNodes.length === textNodes.length) obj = [].slice.call(xml.childNodes).reduce(function(text, node) {
        return text + node.nodeValue;
    }, "");
    else if (xml.hasChildNodes()) for(var i = 0; i < xml.childNodes.length; i++){
...
function loginWithGoogle(e) {
    ...
    (0, _auth.signInWithPopup)(auth, provider).then((result)=>{
        ...
        else (0, _notiflixNotifyAio.Notify).success("Successfully signed up");
        closeModal();
...
},{"firebase/app":"aM3Fo","firebase/auth":"79vzg","notiflix/build/notiflix-notify-aio":"eXQLZ"}],"aM3Fo":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"du6lR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class PersistenceUserManager {
    constructor(persistence, auth, userKey){
        ...
        this.fullPersistenceKey = _persistenceKeyName("persistence" /* KeyName.PERSISTENCE_USER */ , config.apiKey, name1);
 ...
 *
 * @public
 */ async function sendSignInLinkToEmail(auth, email, actionCodeSettings1) {
    const authInternal = _castAuth(auth);
    const request1 = {
    ...
    setActionCodeSettings(request1, actionCodeSettings1);
    await handleRecaptchaFlow(authInternal, request1, "getOobCode" /* RecaptchaActionName.GET_OOB_CODE */ , sendSignInLinkToEmail$1);
}
/**
...
/** @internal */ function registerAuth(clientPlatform) {
    ...
    (0, _app._registerComponent)(new (0, _component.Component)("auth-internal" /* _ComponentName.AUTH_INTERNAL */ , (container)=>{
        const auth1 = _castAuth(container.getProvider("auth" /* _ComponentName.AUTH */ ).getImmediate());
...
},{"@firebase/util":"ePiK6","@firebase/app":"3AcPV","@firebase/logger":"fZmft","tslib":"lRdW5","@firebase/component":"bi1VB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
